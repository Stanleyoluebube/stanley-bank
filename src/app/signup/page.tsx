    ...
    <div className="min-h-screen bg-background flex items-center justify-center px-6">
      ...
      >
        <div className="text-center mb-8">
          ...
          <p className="text-slate-600 dark:text-slate-400 mt-2">Join Stanley Bank today</p>
        </div>
        ...
        <p className="text-center text-sm text-slate-600 dark:text-slate-400 mt-8">
          ...
          <Link href="/login" className="text-primary hover:text-secondary font-bold">Sign in here</Link>
        </p>
      </motion.div>
    </div>
  );
